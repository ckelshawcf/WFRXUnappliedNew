...
public sealed class FindReciepts : OpenSpan.Automation.Automator
{
	...
	public FindReciepts()
	{
		...
		this.SetId(this.connectableMethod59, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DBC582CCE4BDF4"));
		this.SetId(this.connectableMethod60, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DBC582F3A9D1D5"));
		this.SetId(this.connectableMethod61, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DBC5830B17FAA9"));
		// 
		// FindReciepts
		// 
		ComponentInfo.CodeDomData = _resources_.GetString("_FindReciepts_1_");
		this.DocumentScale = 0.3650907F;
		...
		this.catchHost1.CaughtLinkIDs.Add(360);
		this.catchHost1.CaughtLinkIDs.Add(362);
		this.catchHost1.CaughtLinkIDs.Add(363);
		...
		parameterprototype74.DefaultValue = "120000";
		...
		this.catchHost4.CaughtLinkIDs.Add(357);
		this.catchHost4.CaughtLinkIDs.Add(360);
		this.catchHost4.CaughtLinkIDs.Add(362);
		...
		// connectableMethod59
		// 
		this.connectableMethod59.DisplayName = "<Rematch>";
		this.connectableMethod59.ExceptionsHandled = false;
		this.connectableMethod59.InstanceTypeName = "OpenSpan.Adapters.Controls.TextBox";
		this.connectableMethod59.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("WindowsAdapter-8DADC30F66B21EE\\TextBox-8DAED95999E0535");
		memberprototype85.DefaultValue = null;
		memberprototype85.MemberName = "Rematch";
		...
		this.connectableMethod59.MemberPrototypes.Add(memberprototype85);
		this.connectableMethod59.ParamsLength = 0;
		this.connectableMethod59.SerializedParamsDefaultValues = "";
		// 
		// connectableMethod60
		// 
		this.connectableMethod60.DisplayName = "<Sleep>";
		this.connectableMethod60.ExceptionsHandled = false;
		this.connectableMethod60.InstanceTypeName = "OpenSpan.Controls.Pause";
		this.connectableMethod60.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD3799C220137\\Pause-8DADC53F00CC8BB");
		memberprototype86.DefaultValue = null;
		memberprototype86.MemberName = "Sleep";
		...
		parameterprototype83.DefaultValue = "15000";
		parameterprototype83.ParamName = "milliseconds";
		parameterprototype83.Position = 0;
		parameterprototype83.TypeName = "System.Int32";
		memberprototype86.Signature.ParameterPrototype.Add(parameterprototype83);
		memberprototype86.Signature.ReturnType = "System.Void";
		memberprototype86.TypeName = "System.Void";
		this.connectableMethod60.MemberPrototypes.Add(memberprototype86);
		this.connectableMethod60.ParamsLength = 0;
		this.connectableMethod60.SerializedParamsDefaultValues = "";
		// 
		// connectableMethod61
		// 
		this.connectableMethod61.DisplayName = "<WaitForCreate>";
		...
		dynamicpropertyinfo52.CodeDomData = _resources_.GetString("_FindReciepts_19_");
		this.connectableMethod61.DynamicMembers.Add(dynamicpropertyinfo52);
		this.connectableMethod61.ExceptionsHandled = false;
		this.connectableMethod61.InstanceTypeName = "OpenSpan.Adapters.Controls.TextBox";
		this.connectableMethod61.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("WindowsAdapter-8DADC30F66B21EE\\TextBox-8DAED95999E0535");
		memberprototype87.DefaultValue = null;
		memberprototype87.MemberName = "WaitForCreate";
		...
		parameterprototype84.DefaultValue = "120000";
		parameterprototype84.ParamName = "milliseconds";
		parameterprototype84.Position = 0;
		parameterprototype84.TypeName = "System.Int32";
		memberprototype87.Signature.ParameterPrototype.Add(parameterprototype84);
		memberprototype87.Signature.ReturnType = "System.Boolean";
		memberprototype87.TypeName = "System.Boolean";
		this.connectableMethod61.MemberPrototypes.Add(memberprototype87);
	...
	internal OpenSpan.Automation.CatchHost Create_catchHost1(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		catchHost1.CaughtLinkIDs.Add(360);
		catchHost1.CaughtLinkIDs.Add(362);
		catchHost1.CaughtLinkIDs.Add(363);
	...
	internal OpenSpan.Automation.CatchHost Create_catchHost4(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		catchHost4.CaughtLinkIDs.Add(357);
		catchHost4.CaughtLinkIDs.Add(360);
		catchHost4.CaughtLinkIDs.Add(362);
	...
	internal OpenSpan.Automation.ConnectableMethod Create_connectableMethod59(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableMethod59, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DBC582CCE4BDF4"));
		connectableMethod59.DisplayName = "<Rematch>";
		connectableMethod59.ExceptionsHandled = false;
		connectableMethod59.InstanceTypeName = "OpenSpan.Adapters.Controls.TextBox";
		connectableMethod59.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("WindowsAdapter-8DADC30F66B21EE\\TextBox-8DAED95999E0535");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
		memberprototype1.MemberName = "Rematch";
		memberprototype1.MemberType = System.Reflection.MemberTypes.Method;
	...
	internal OpenSpan.Automation.ConnectableMethod Create_connectableMethod60(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableMethod60, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DBC582F3A9D1D5"));
		connectableMethod60.DisplayName = "<Sleep>";
		connectableMethod60.ExceptionsHandled = false;
		connectableMethod60.InstanceTypeName = "OpenSpan.Controls.Pause";
		connectableMethod60.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD3799C220137\\Pause-8DADC53F00CC8BB");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
		memberprototype1.MemberName = "Sleep";
		memberprototype1.MemberType = System.Reflection.MemberTypes.Method;
		...
		parameterprototype1.CanWrite = true;
		parameterprototype1.DefaultSet = true;
		parameterprototype1.DefaultValue = "15000";
		parameterprototype1.ParamName = "milliseconds";
		parameterprototype1.Position = 0;
		parameterprototype1.TypeName = "System.Int32";
		memberprototype1.Signature.ParameterPrototype.Add(parameterprototype1);
	...
	internal OpenSpan.Automation.ConnectableMethod Create_connectableMethod61(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableMethod61, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DBC5830B17FAA9"));
		connectableMethod61.DisplayName = "<WaitForCreate>";
		OpenSpan.DynamicMembers.DynamicPropertyInfo dynamicpropertyinfo1 = new OpenSpan.DynamicMembers.DynamicPropertyInfo();
		dynamicpropertyinfo1.IsSerializable = true;
		dynamicpropertyinfo1.NoInputConvesion = false;
		dynamicpropertyinfo1.Source = "";
		...
		connectableMethod61.InstanceTypeName = "OpenSpan.Adapters.Controls.TextBox";
		connectableMethod61.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("WindowsAdapter-8DADC30F66B21EE\\TextBox-8DAED95999E0535");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
		memberprototype1.MemberName = "WaitForCreate";
		memberprototype1.MemberType = System.Reflection.MemberTypes.Method;
